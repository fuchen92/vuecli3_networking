                            ...
                            <template v-for="(industry, industryIndex) in category.Value">
                                <div class="filterCard" :key="industryIndex">
                                    ...
                                    <div class="filterTags">
                                        <label class="filterLabel" v-for="(tag1, tagidx1) in industry.Value" :key="tagidx1" :value="tag1.Id">
                                            <input class="filterCheckBox" type="checkbox" :value="tag1.Id" v-model="industryArr">
                                            <i class="filterTag">
                                                {{ tag1.Name }}
                                            </i>
                                        </label>
